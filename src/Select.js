...
const Select = createReactClass({
	...
	propTypes: {
		...
		lockScroll: PropTypes.bool,           // whether the menu should avoid propagation of scroll
		...
		multiSelectAll: PropTypes.bool,
		multiSelectAllText: PropTypes.string,
		...
		onClose: PropTypes.func,              // fires before the menu closes
		onCloseResetsInput: PropTypes.bool,		// whether input is cleared when menu is closed through the arrow
		onClosed: PropTypes.func,             // fires after the menu closes
		onFocus: PropTypes.func,              // onFocus handler: function (event) {}
		onInputChange: PropTypes.func,        // onInputChange handler: function (inputValue) {}
		onInputKeyDown: PropTypes.func,       // input keyDown handler: function (event) {}
		onKeyDown: PropTypes.func,            // onKeyDown handler: function (event, isOpen) {}
		onMenuScrollToBottom: PropTypes.func, // fires when the menu is scrolled to the bottom; can be used to paginate options
		onOpen: PropTypes.func,               // fires before the menu opens
		onOpened: PropTypes.func,             // fires after the menu opens
  ...
  shouldComponentUpdate: shouldPureComponentUpdate,
	...
	componentDidUpdate (prevProps, prevState) {
		if (prevState.isOpen !== this.state.isOpen) {
			const handler = this.state.isOpen ? this.props.onOpened : this.props.onClosed;
			handler && handler();
		}
